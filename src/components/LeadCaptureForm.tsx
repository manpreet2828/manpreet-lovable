      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-card border border-border backdrop-blur-sm animate-slide-up">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button
            type="submit"
            disabled={loading}
            className={`w-full h-12 font-semibold rounded-lg shadow-glow transition-smooth transform hover:scale-[1.02]
              ${loading ? 'bg-gray-400 cursor-not-allowed' : 'bg-gradient-primary text-primary-foreground hover:shadow-[0_0_60px_hsl(210_100%_60%/0.3)]'}
            `}
          >
            {loading ? (
              <>
